...
type VoteArtistRequest struct {
	UserId string `protobuf:"bytes,1,opt,name=user_id" json:"user_id,omitempty"`
	Artist string `protobuf:"bytes,2,opt,name=artist" json:"artist,omitempty"`
	Like   bool   `protobuf:"varint,3,opt,name=like" json:"like,omitempty"`
}

func (m *VoteArtistRequest) Reset()                    { *m = VoteArtistRequest{} }
func (m *VoteArtistRequest) String() string            { return proto.CompactTextString(m) }
func (*VoteArtistRequest) ProtoMessage()               {}
func (*VoteArtistRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }

type VoteArtistResponse struct {
}

func (m *VoteArtistResponse) Reset()                    { *m = VoteArtistResponse{} }
func (m *VoteArtistResponse) String() string            { return proto.CompactTextString(m) }
func (*VoteArtistResponse) ProtoMessage()               {}
func (*VoteArtistResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*VoteSkipRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*VoteSkipResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func init() {
	...
	proto.RegisterType((*VoteArtistRequest)(nil), "CrowdSound.VoteArtistRequest")
	proto.RegisterType((*VoteArtistResponse)(nil), "CrowdSound.VoteArtistResponse")
...
type CrowdSoundClient interface {
	...
	// GetSessionData returns data about the session.
	...
	// VoteArtist informs the CrowdSound service of a vote for a Song.
	VoteArtist(ctx context.Context, in *VoteArtistRequest, opts ...grpc.CallOption) (*VoteArtistResponse, error)
...
func (c *crowdSoundClient) VoteArtist(ctx context.Context, in *VoteArtistRequest, opts ...grpc.CallOption) (*VoteArtistResponse, error) {
	out := new(VoteArtistResponse)
	err := grpc.Invoke(ctx, "/CrowdSound.CrowdSound/VoteArtist", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CrowdSoundServer interface {
	...
	// VoteArtist informs the CrowdSound service of a vote for a Song.
	VoteArtist(context.Context, *VoteArtistRequest) (*VoteArtistResponse, error)
	// VoteSkip votes to skip the currently playing song.
...
func _CrowdSound_VoteArtist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(VoteArtistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(CrowdSoundServer).VoteArtist(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _CrowdSound_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VoteArtist",
			Handler:    _CrowdSound_VoteArtist_Handler,
		},
		{
			MethodName: "VoteSkip",
...
var fileDescriptor0 = []byte{
	...
	,
}
